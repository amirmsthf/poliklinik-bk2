      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
        <li class="nav-item">
          <a href="#" class="nav-link" id="jadwal-periksa">
            <i class="nav-icon far fa-calendar-alt"></i> <!-- Ikon Jadwal -->
            <p>Jadwal Periksa</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link" id="memeriksa-pasien">
            <i class="nav-icon fas fa-stethoscope"></i> <!-- Ikon Memeriksa Pasien -->
            <p>Memeriksa Pasien</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link" id="riwayat-pasien">
            <i class="nav-icon fas fa-history"></i> <!-- Ikon Riwayat Pasien -->
            <p>Riwayat Pasien</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link" id="profil">
            <i class="nav-icon fas fa-user"></i> <!-- Ikon Profil -->
            <p>Profil</p>
          </a>
        </li>
